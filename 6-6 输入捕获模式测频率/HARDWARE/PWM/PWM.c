...
void PWM_Init(void)
{
    ...
    */
    ...
    TIM_OC1Init(TIM2, &TIM_OCInitStructure); // 初始化TIM2通道1的输出比较

    // 5. 配置PWM对应的GPIO
    GPIO_InitTypeDef GPIO_InitStructure; // 定义GPIO初始化结构体
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0; // 选择PA0引脚, TIM2_CH1_ETR默认映射到PA0
...
{
    TIM_PrescalerConfig(TIM2, Prescaler, TIM_PSCReloadMode_Immediate); // 设置TIM2的预分频器
}
